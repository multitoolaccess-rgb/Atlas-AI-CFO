...
| risk-p1-account-currency-authority | Active account balances cannot support a projection envelope unless explicit source-backed currency evidence is present. | high | high | Require bounded provider, statement, or explicit user-confirmed evidence; no backfill or preference/default inference; fail closed for unknown, mixed, stale, unsupported, or conflicting currency. | Finlynq domain owner | open | B0 provider prerequisite, ADR-006 |
