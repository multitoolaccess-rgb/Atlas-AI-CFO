/**
 * Inactive information-architecture contract for the staged migration.
 * Do not import this from the production Sidebar until its destinations exist.
 */
...
export const PROPOSED_NAVIGATION: readonly ProposedNavigationGroup[] = [
  ...
  { id: 'wealth', label: 'Wealth', destinations: [
    ...
    { id: 'portfolio', label: 'Portfolio', path: '/portfolio', icon: 'portfolio', activeMatch: ['/portfolio'], activated: false, tabs: [tab('holdings', 'Holdings'), tab('allocation', 'Allocation'), tab('performance', 'Performance'), tab('risk', 'Risk')] },
    { id: 'goals', label: 'Goals', path: '/goals', icon: 'goals', activeMatch: ['/goals'], activated: false, tabs: [tab('goals', 'Goals'), tab('forecasts', 'Forecasts'), tab('progress', 'Progress')] },
  ] },
