...
const tabs = [{ id: 'scenarios', label: 'Scenarios' }, { id: 'comparisons', label: 'Comparisons' }, { id: 'life-events', label: 'Life events' }, { id: 'financial-twin', label: 'Financial Twin' }] as const
