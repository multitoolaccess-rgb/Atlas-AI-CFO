...
class InvestmentCommitteeRun(Base):
    ...
    evidence_packet_id = Column(String(128), ForeignKey("investment_evidence_packets.packet_id", ondelete="RESTRICT"), nullable=True)
...
class InvestmentOutcomeRecord(Base):
    ...
    recommendation_hash = Column(String(64), nullable=False)
    decision_id = Column(String(160), ForeignKey("investment_decision_records.decision_id", ondelete="RESTRICT"), nullable=True, index=True)
